...
/**
 * This is the item provider adapter for a {@link kr.ac.hanyang.tosca2camp.rest.model.DataModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataModel_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataModel_value_feature", "_UI_DataModel_type"),
				 ModelPackage.Literals.DATA_MODEL__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Object labelValue = ((DataModel)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataModel.class)) {
			case ModelPackage.DATA_MODEL__VALUE:
